...
<?php $component->withAttributes([]); ?>
    <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
        <?php echo e(__('パスワードをお忘れですか?大丈夫。メールアドレスをお知らせいただければ、新しいパスワードリセットリンクを選択できるように、パスワードリセットリンクをメールで送信します。')); ?>
...
<?php endif; ?>
<?php /**PATH /Volumes/Extreme SSD/work-site_pro/test_site/bbs-app/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>