...
<?php endif; ?>
    <h2 class="text-center text-xl font-semibold text-white dark:bg-gray-800 my-4">ログイン</h2>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('register')); ?>" class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">アカウントをお持ちでない方はこちら</a>
            </div>
...
<?php endif; ?>
<?php /**PATH /Volumes/Extreme SSD/work-site_pro/test_site/bbs-app/resources/views/auth/login.blade.php ENDPATH**/ ?>