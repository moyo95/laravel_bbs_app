                ...
                <div class="p-6 sm:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="<?php echo e(route('contact.confirm')); ?>"> 
                        ...
                        <div>
                            ...
                            <input id="name" name="name" type="text" value="<?php echo e(old('name')); ?>" required autofocus placeholder="名前（必須）"
...
<?php endif; ?>
                        ...
                        <div class="mt-4">
                            ...
                            <input id="email" name="email" type="email" value="<?php echo e(old('email')); ?>" required placeholder="メールアドレス（必須）"
                                   class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
...
<?php endif; ?>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="message" name="message" rows="5" required placeholder="メッセージを入力してください"
                                      class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"><?php echo e(old('message')); ?></textarea>
...
<?php endif; ?><?php /**PATH /Volumes/Extreme SSD/work-site_pro/test_site/bbs-app/resources/views/contact/index.blade.php ENDPATH**/ ?>