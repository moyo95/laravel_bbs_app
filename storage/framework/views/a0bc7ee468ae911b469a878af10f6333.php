                ...
                <div class="p-6 sm:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="<?php echo e(route('posts.update', $post->id)); ?>">
                        ...
                        <div>
                            ...
                            <input id="title" name="title" type="text" value="<?php echo e(old('title', $post->title)); ?>" required autofocus
...
<?php endif; ?>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="content" name="content" rows="10" required
                                      class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"><?php echo e(old('content', $post->content)); ?></textarea>
                            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div class="flex items-center justify-end mt-4 space-x-4">
                            <a href="<?php echo e(route('posts.show', $post->id)); ?>" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 ...">
                                キャンセル
                            </a>
...
<?php endif; ?><?php /**PATH /Volumes/Extreme SSD/work-site_pro/test_site/bbs-app/resources/views/posts/edit.blade.php ENDPATH**/ ?>